...
import { SunIcon, MoonIcon, CopyIcon, ShareIcon, PhoneIcon } from '../common/icons';
  ...
  const handleShare = () => {
    if ('share' in navigator) {
      navigator
        .share({
          title: 'Relay',
          text: 'Join my secure encrypted chat on Relay',
    ...
    <header className={`chat-header glass ${isConnected ? 'active' : ''}`}>
      <div className="header-info">
        <div className="title-row">
          ...
          <h2 className="channel-title">Relay Channel</h2>
